  ...
  return (
    <div className="w-[1296px] items-center flex flex-col gap-[4rem] justify-start py-[7.5rem] relative">
      ...
      <div className="w-full">
        <section className="flex flex-col items-center gap-12 max-w-screen-2xl m-auto w-full">
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            <div className="flex min-h-[520px] max-w-md flex-col items-start justify-between gap-12 overflow-hidden rounded-none border p-6 border-slate-200 bg-white">
              <div className="inline-flex flex-col items-start justify-start gap-6">
                <div className="flex flex-col items-start justify-start gap-4">
                  ...
                  <p className="inline-flex items-end justify-start gap-2">
                    <span className="text-center text-5xl font-medium">$0</span>
                ...
                <div className="flex flex-col gap-6 text-slate-600">
                  ...
                  <div className="flex flex-col items-start justify-start gap-4">
                    ...
                    <div className="inline-flex items-center justify-start gap-3">
                      ...
                      <p className="text-sm">Up to 1,000 subscribers</p>
                    </div>
                    <div className="inline-flex items-center justify-start gap-3">
                      <svg
                        width="20"
                    ...
                    <div className="inline-flex items-center justify-start gap-3">
                      ...
                      <p className="text-sm">48-hour support response time</p>
                    </div>
                  </div>
                </div>
              </div>
              <div className="w-full flex justify-center">
                <button
                  type="button"
                  className="text-center flex justify-center items-center w-full h-[3.5rem] text-[1rem] font-medium outline outline-[1px] outline-black"
                >
                  <span>Buy Now</span>
                </button>
              </div>
            ...
            <div className="flex min-h-[520px] max-w-md flex-col items-start justify-between gap-12 overflow-hidden rounded-none border p-6 border-transparent bg-gray-950 text-white">
              <div className="inline-flex flex-col items-start justify-start gap-6">
                <div className="flex flex-col items-start justify-start gap-4">
                ...
                <div className="flex flex-col gap-6 text-white">
                  ...
                  <div className="flex flex-col items-start justify-start gap-4">
                    <div className="inline-flex items-center justify-start gap-3">
                      ...
                      <p className="text-sm">10 products</p>
                    </div>
                    <div className="inline-flex items-center justify-start gap-3">
                      <svg
                        width="20"
                      ...
                      <p className="text-sm">Up to 10,000 subscribers</p>
                    </div>
                    <div className="inline-flex items-center justify-start gap-3">
                      <svg
                        width="20"
                    ...
                    <div className="inline-flex items-center justify-start gap-3">
                      ...
                      <p className="text-sm">24-hour support response time</p>
                    </div>
                  </div>
                </div>
              </div>
              <div className="w-full flex justify-center">
                <button
                  type="button"
                  className="text-center flex justify-center items-center w-full h-[3.5rem] text-[1rem] font-medium outline outline-[1px] outline-gray-50"
                >
                  <span>Buy Now</span>
                </button>
              </div>
                ...
                <div className="flex flex-col gap-6 text-slate-600">
                  ...
                  <div className="flex flex-col items-start justify-start gap-4">
                    <div className="inline-flex items-center justify-start gap-3">
                      ...
                      <p className="text-sm">Unlimited products</p>
                    </div>
                    <div className="inline-flex items-center justify-start gap-3">
                      <svg
                        width="20"
                      ...
                      <p className="text-sm">Unlimited subscribers</p>
                    </div>
                    <div className="inline-flex items-center justify-start gap-3">
                      <svg
                        width="20"
                    ...
                    <div className="inline-flex items-center justify-start gap-3">
                      ...
                      <p className="text-sm">12-hour support response time</p>
                    </div>
                    <div className="inline-flex items-center justify-start gap-3">
                      <svg
                        width="20"
                    ...
                    <div className="inline-flex items-center justify-start gap-3">
                      ...
                      <p className="text-sm">Custom API development</p>
                    </div>
                  </div>
                </div>
              </div>
